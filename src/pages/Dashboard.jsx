...
export default function Dashboard() {
  ...
  const levelProgress = ((currentUser?.xp || 0) % 250) / 2.5;
    ...
    <section className="space-y-6">
      <Card className="bg-gradient-to-br from-indigo-600 to-cyan-500 text-white">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-3">
          <div className="rounded-3xl bg-white/15 p-4"><p>XP</p><strong className="text-3xl">{currentUser?.xp}</strong></div>
          <div className="rounded-3xl bg-white/15 p-4"><p>Nível</p><strong className="text-3xl">{level}</strong><Progress value={levelProgress} color="bg-amber-300" /></div>
