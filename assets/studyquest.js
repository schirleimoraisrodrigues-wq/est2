...
function layout(content) {
  ...
  return `<div class="app">
    <aside class="sidebar" id="sidebar">
      <div class="brand"><div class="brand-mark">∿</div><div><strong>Terminal engenharia</strong><span>terminal de estudos</span></div></div>
